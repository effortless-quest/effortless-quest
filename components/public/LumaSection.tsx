        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="mb-4" style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(1.8rem, 3.5vw, 2.6rem)', color: '#fff', lineHeight: 1.2 }}>
              Power Your Quest<br />with <span style={{ color: 'var(--cyan)' }}>Luma AI</span>
            </h2>
            <p className="text-base leading-8 mb-7" style={{ color: 'var(--muted)' }}>
              Effortless Quest is the official home for the Luma AI community. Use AI to create, innovate, and dominate your quests — from generating business ideas to visualizing your next invention.
            </p>
            <ul className="list-none flex flex-col gap-3 mb-8">
              {[
                'Generate quest strategies and business plans with AI',
                'Create stunning visuals for your Invention Center submissions',
                'AI-powered coaching for personal development quests',
                'Luma Dream Machine integration for creative projects',
                'Exclusive Effortless Quest + Luma AI missions',
              ].map(f => (
            ...
            <div className="flex gap-3 flex-wrap">
              {[
                { icon: '🍎', small: 'Download on the', strong: 'App Store' },
                { icon: '🤖', small: 'Get it on', strong: 'Google Play' },
                { icon: '💻', small: 'Use on', strong: 'Web App' },
              ].map(btn => (
                <a
                  key={btn.strong}
                  href="#"
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <small className="text-[.65rem] tracking-wide uppercase" style={{ color: 'var(--muted)' }}>{btn.small}</small>
                    <strong className="text-sm font-bold">{btn.strong}</strong>
                  </div>
                </a>
              ))}
            </div>
          ...
          >
            ...
            <p className="text-sm mt-2 text-center" style={{ color: 'var(--muted)' }}>Official Effortless Quest Partner</p>
          </div>
        </div>
      </div>
    </section>
